  ...
  >
    ...
    <div v-else-if="props.email" class="flex flex-col gap-6">
      ...
      <div class="border-b border-gray-200 dark:border-gray-700 pb-4">
        <div class="email-detail-heading flex items-start justify-between mb-4">
          <div class="flex-1">
            <div class="flex flex-col gap-2 text-sm text-gray-600 dark:text-gray-400">
              <div class="email-detail-meta flex items-center space-x-2">
          ...
          <div v-if="props.email.verification_code" class="ml-4">
            <div class="bg-green-100 dark:bg-green-900/20 p-3 rounded-lg">
              <div class="flex items-center space-x-2 mb-2">
                ...
                />
                <span class="text-sm font-medium text-green-700 dark:text-green-300"> 验证码 </span>
              </div>
      ...
      <div class="flex flex-col gap-4">
        ...
        <div v-if="props.email.content" class="flex flex-col gap-2">
          <h4 class="font-medium text-gray-900 dark:text-gray-100">邮件内容</h4>
          <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
            <pre class="whitespace-pre-wrap text-sm text-gray-700 dark:text-gray-300 font-mono">{{
              props.email.content
            }}</pre>
          </div>
        ...
        <div v-if="props.email.html_content" class="flex flex-col gap-2">
          <h4 class="font-medium text-gray-900 dark:text-gray-100">HTML 内容</h4>
        ...
        <div v-if="!props.email.content && !props.email.html_content" class="text-center py-8">
          ...
          />
          <p class="text-gray-500 dark:text-gray-400">此邮件没有内容</p>
        </div>
      </div>
    </div>
