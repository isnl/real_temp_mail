...
onMounted(async () => {
  ...
  try {
    loading.value = true
    await Promise.all([emailStore.fetchTempEmails(), fetchQuotaInfo()])
  } catch (error) {
        ...
        <div class="profile-account-grid grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          >
            <div class="flex items-center mb-2">
              <font-awesome-icon
                :icon="['fas', 'envelope']"
                class="text-primary-500 text-sm mr-2"
              />
          ...
          >
            <div class="flex items-center mb-2">
              <font-awesome-icon
                ...
                class="text-green-500 text-sm mr-2"
              />
    ...
    <div class="card-base p-6">
      ...
      <div class="profile-shortcuts-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            <div class="text-center">
              <font-awesome-icon
                ...
                class="text-primary-500 text-2xl mb-2"
              />
        ...
        <router-link to="/profile" class="block">
          ...
          >
            <div class="text-center">
              <font-awesome-icon :icon="['fas', 'gift']" class="text-primary-500 text-2xl mb-2" />
